...
#### Function definition for comments retrieval
"""
...
def video_comments(video_id):
	...
	while video_response and len(comments) < 100:
...
"""#### Retrieving comments from specified video"""

# Enter video link
# https://www.youtube.com/watch?v=GMbn7JY9D1U
...
#### Install required module and import
"""
...
print('Authenticating with pre-made token')
aToken = "EAAVH4fqisfcBANTjrrD4Q0ZBsXcy1C8dgkDu6wZAe6ZCnZAr4aGhyfo4ZBCgTazeKUuaYFSkJPZCF1wxY04IXW6ITMPR7DlMRD9DyLDJN0bxsXszuatJniUPZCVX0AVNJMBmfBlJcZAeZAFelkH3RYXL4A2jxChOv6PLI4Px1f1vCN4rwnVS2oBmv"
graph = facebook.GraphAPI(access_token=aToken)

print('Requesting posts')
response = graph.request('me?fields=posts')

print("Extracting posts' text content ...")
...
print( '\nFound {p} posts, with {r} requests\n'.format(p=len(posts), r=num_requests) )
...
But there's currently no way to retrieve tyhe token it generates, since no redirect URL that can extract it has been built
"""

app_id = "1486410781733367"
# The redirect URL goes in canvas_url, the google website is just a stand-in
canvas_url = "https://www.google.com"
perms = ['user_posts', 'public_profile']
